  ...
  return (
    <div className='bg-[#F2F2F2] relative h-full w-full '>
      <div>
        ...
        <h1 className='absolute left-1/2 top-20 transform -translate-x-1/2 text-[#ECE8E1] text-8xl font-bold drop-shadow-lg bg-gradient-to-r from-[#c48a39] to-[#ECE8E1] text-transparent bg-clip-text mt-40' >
          Valor Vault : 
        </h1>
         <h2 className='absolute left-1/2 top-48 transform -translate-x-1/2 text-6xl font-semibold drop-shadow-lg bg-gradient-to-r from-[#c48a39] to-[#ECE8E1] text-transparent bg-clip-text whitespace-nowrap  mt-40'>
